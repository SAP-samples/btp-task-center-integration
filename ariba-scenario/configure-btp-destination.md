<p>The next step will be to configure your destinations for SAP Ariba in your BTP Sub Account. This allow an endpoint to be created for the data to flow between SAP Ariba and SAP Task Center.</p>
